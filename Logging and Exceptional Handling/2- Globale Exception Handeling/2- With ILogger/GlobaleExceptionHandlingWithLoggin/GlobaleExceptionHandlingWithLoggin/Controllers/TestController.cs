...
namespace GlobaleExceptionHandlingWithLoggin.Controllers
{
    ...
    public class TestController : ControllerBase
    {
        ...
        {
            //exception with logging
            throw new Exception("An error occurred while fetching students in GetAllStudents Action.");
            return Ok(students);
        }
    }
}
//1- create a customer middleware class for global exception handling and logging
